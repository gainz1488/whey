...
(((They))) got to him. RIP you crazy bastard.
...
For telegram I suggest @littlemcafee
...
contract LittleMcAfee is Context, IERC20, Ownable, ReentrancyGuard {
    ...
    string private _name = "LittleMcAfee";
    string private _symbol = "LMCAFEE";
