...
I present to you Little Bald Eagle, the most bad ass creature on Earth

Slightly tweaked tokenomics compared to other recent Little coins.

Reduced total supply and increased max transaction slightly.

Not burning any coins initially. Will send all to LP. No dev wallet.

Burning LP to dead wallet a few minutes after launch.

10% tax on every transaction, 8% goes to HODLERS and 2% is burned.

I hate rugs so not happening.

For telegram I suggest @littlebaldeagle
...
contract LittleBaldEagle is Context, IERC20, Ownable, ReentrancyGuard {
    ...
    string private _name = "LittleBaldEagle";
    string private _symbol = "LBALD";
    ...
    uint256 public _maxTxAmount = 4000000000000000 * 10**9;
